...
keymap.set("i", "<C-b>", "<ESC>^i", {}) -- beginning of line
...
keymap.set('n', '<leader>fw', require('telescope.builtin').live_grep, {})
keymap.set('n', '<leader>fb', require('telescope.builtin').buffers, {})
keymap.set('n', '<leader>fz', require('telescope.builtin').current_buffer_fuzzy_find, {})
